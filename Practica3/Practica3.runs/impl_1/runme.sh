...
HD_PWD='C:/Users/practicas/Desktop/Practica3/Practica3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log circuito.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source circuito.tcl -notrace
